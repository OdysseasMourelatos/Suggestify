...
if st.session_state.upload_state == "idle":
    ...
    with tab_live:
        ...
        with col2:
            ...
            st.markdown(f"""
            <a href="{spotify_auth_url}" target="_blank" style="display: block; text-align: center; background: #1DB954; color: #000; font-weight: 800; font-size: 1rem; text-decoration: none; border-radius: 999px; padding: 0.8rem 2rem; transition: all 0.2s ease; box-shadow: 0 4px 24px rgba(29,185,84,0.25);">
